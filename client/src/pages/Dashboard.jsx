...
const Dashboard = () => {
    ...
    const uploadResume = async (event) => {
        ...
        try {
            ...
            const { data } = await api.post('/api/ai/upload-resumes', { title, resumeText }, {
                headers: {
                    Authorization: token
                }
            })
    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                {showCreateResume && (
                    <form onSubmit={createResume} onClick={() => setShowCreateResume(false)} className="fixed inset-0 bg-black/70 backdrop-blue bg-opacity-50 z-10 flex items-center justify-center">
                ...
                {showUploadResume && (
                    <form onSubmit={uploadResume} onClick={() => setShowUploadResume(false)} className="fixed inset-0 bg-black/70 backdrop-blue bg-opacity-50 z-10 flex items-center justify-center">
                        <div onClick={e => e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
                ...
                {editResumeId && (
                    <form onSubmit={editTitle} onClick={() => setEditResumeId('')} className="fixed inset-0 bg-black/70 backdrop-blue bg-opacity-50 z-10 flex items-center justify-center">
                        <div onClick={e => e.stopPropagation()} className="relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6">
